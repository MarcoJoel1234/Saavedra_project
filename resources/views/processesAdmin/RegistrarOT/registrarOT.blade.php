        ...
        <form action="{{ route('saveOT') }}" method="POST" class="pt-3">
            <div class="wrapper bg-white">
                ...
                @if (isset($ot))
                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3" id="tabla3">
                            ...
                            @if (isset($clasesEncontradas) && count($clasesEncontradas) > 0)
                ...
                <div class="text-center pt-3 text-muted" style="padding:10px; display:flex; justify-content:center;">
                    @if (isset($clasesEncontradas) && count($clasesEncontradas) > 0)
                        <a href="{{ route('mostrarClases', ['ot' => $ot]) }}" class="btn text-center my-1">Editar
                            OT</a>
                    @endif
                    <a href="#" class="btn text-center my-1"
                        style="background-color: blue; margin-left:10px;">Generar PDF</a>
                    <button id="btn-deleteOT" class="btn text-center my-1"
                        style="background-color: red; margin-left:10px;">Eliminar OT</button>
                </div>
                <script>
            ...
            @else
                ...
                <div class="botones-ot">
                    <!--Al iniciar con el perfil de almacen unicamente aparece el boton "Seleccionar OT"-->
                    @if ($layout == 'layouts.appAdmin')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-outline">
                                    ...
                                    <input type="number" id="otCreate" name="ot"
                                        placeholder="Orden de trabajo." class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group py-2">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <div class="form-outline">
                                    @isset($ordenesTrabajo)
                                        @php
                                            $contador = 0;
                                        @endphp
                                        <select id="datos" class="form-control" name="otSeleccionada">
                                            @foreach ($ordenesTrabajo as $ot)
                                                <option value="{{ $ordenesTrabajo[$contador]['ot'] }}">
                                                    {{ $ordenesTrabajo[$contador]['ot'] }} -
                                                    {{ $ordenesTrabajo[$contador]['moldura'] }}
                                                </option>
                                                @php
                                                    $contador++;
                                                @endphp
