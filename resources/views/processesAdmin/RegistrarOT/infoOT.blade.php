        ...
        <div class="wrapper bg-white">
            ...
            @isset($edit)
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <div class="form-outline">
                            ...
                            <input type="number" id="pedido" name="pedido" placeholder="Pedido total." value="{{$clase->pedido}}" class="form-control" required/>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <div class="form-outline">
                            <label style="color: green; font-weight: bold;">Inserta las piezas:</label><br>
                            <input type="number" id="piezas" name="piezas" placeholder="Cantidad de piezas." value="{{$clase->piezas}}" class="form-control"   required/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="form-outline" id="div-select">
                            @if ($clase->nombre == "Obturador")
                                <label id="titulo-select" style="color: green; font-weight: bold;">Seleccione la sección:</label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <div class="form-outline">
                            ...
                            <input type="date" id="fecha_inicio" name="fecha_inicio" class="form-control" value="{{$clase->fecha_inicio}}" required/>
                        </div>
                    </div>
                    <div class="col-md-6 mb-2">
                        <div class="form-outline">
                            <label style="color: green; font-weight: bold;">Hora de inicio:</label><br>
                            <input type="time" id="hora_inicio" name="hora_inicio" class="form-control" value="{{$clase->hora_inicio}}" required/>
                        </div>
                    </div>
                </div>
                @else
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-outline">
                        ...
                        <input type="number" id="pedido" value="{{$clase->pedido}}" class="form-control" disabled />
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-outline">
                        ...
                        <input type="number" id="piezas" value="{{$clase->piezas}}" class="form-control" disabled />
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-outline" id="div-select">
                        ...
                        <input type="text" id="tamaños" value="{{$clase->seccion}}" class="form-control" disabled />
                        <input type="hidden" name="seccion" value="{{$clase->seccion}}" />
                        @else
                        <label id="titulo-select" style="color: green; font-weight: bold;">Tamaño:</label>
                        <input type="text" id="tamaños" value="{{$clase->tamanio}}" class="form-control" disabled />
            ...
            <div class="row">
                <div class="col-md-6 mb-2">
                    <div class="form-outline">
                        <label style="color: green; font-weight: bold;">Fecha de inicio:</label><br>
                        <input type="date" id="fecha_inicio" value="{{$clase->fecha_inicio}}" class="form-control"
                            disabled />
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-outline">
                        <label style="color: green; font-weight: bold;">Hora de inicio:</label><br>
                        <input type="time" id="fecha_entrega" value="{{$clase->hora_inicio}}" class="form-control"
                            disabled />
            ...
            <div class="row">
                <div class="col-md-6 mb-2">
                    <div class="form-outline">
                        ...
                        @else
                        <input type="date" id="fecha_termino" value="{{$clase->fecha_termino}}" class="form-control" disabled />
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-outline">
                        ...
                        <input type="text" value="-" class="form-control" disabled />
                        @else
                        <input type="time" id="hora_termino" value="{{$clase->hora_termino}}" class="form-control" disabled />
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3" id="tabla3">
                    ...
                    <tr>
                        ...
                        <td style="background-color: #C8E6C9;" class="t-dato">{{$class->nombre}}</td>
                        @if ($class->nombre == "Obturador")
                        <td style="background-color: #C8E6C9;" class="t-dato">{{$class->seccion}}</td>
                        @else
                        <td style="background-color: #C8E6C9;" class="t-dato">{{$class->tamanio}}</td>
                        @endif
                        <td class="t-dato" style="background-color: #C8E6C9;">{{$class->piezas}}</td>
                        <td class="t-dato" style="background-color: #C8E6C9;">{{$class->pedido}}</td>
                        @if (!isset($edit))
                        <td class="t-dato-btn" style="background-color: #C8E6C9;">
                            <div class="images">
                                <a href="{{route('editClase', ['clase' => $class->id])}}" class="btn-table"><img src="{{ asset('images/edit.png') }}"></a>
                            </div>
                            <div class="images">
                                <button class="btn-table" id="btn-delete{{$class->id}}"><img src="{{ asset('images/delete.png') }}"></button>
                            </div>
                        </td>
                        @endif
                        @else
                ...
                @else
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3" style="display:flex; justify-content:center;">
                            <a href="{{route('registerClass', ['ot' => $ot])}}" style="width: 100%;" class="btn">Agregar clase</a>
                        </div>
                        <div class="col-md-6 mb-3" style="margin-top:20px; display:flex; justify-content:center;">
