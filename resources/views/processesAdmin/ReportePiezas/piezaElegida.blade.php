        ...
        crearProceso() { // Crear proceso
            ...
            switch (this.nameProceso) { // Segun el proceso
                case "Cepillado": //Proceso de cepillado
                    ...
                    nombresCnomi = ['id', 'radiof_mordaza', 'radiof_mayor', 'radiof_sufridera', 'profuFinal_CFC', 'profuFinal_mitadMB', 'profuFinal_PCO', 'ensamble', 'distancia_barrenoAli', 'profu_barrenoAliHembra', 'profu_barrenoAliMacho', 'altura_venaHembra', 'altura_venaMacho', 'ancho_vena', 'pin1', 'pin2'];

                    nombresTole = ['id', 'radiof_mordaza1', 'radiof_mordaza2', 'radiof_mayor1', 'radiof_mayor2', 'radiof_sufridera1', 'radiof_sufridera2', 'profuFinal_CFC1', 'profuFinal_CFC2', 'profuFinal_mitadMB1', 'profuFinal_mitadMB2', 'profuFinal_PCO1', 'profuFinal_PCO2', 'ensamble1', 'ensamble2', 'distancia_barrenoAli1', 'distancia_barrenoAli2', 'profu_barrenoAliHembra1', 'profu_barrenoAliHembra2', 'profu_barrenoAliMacho1', 'profu_barrenoAliMacho2', 'altura_venaHembra1', 'altura_venaHembra2', 'altura_venaMacho1', 'altura_venaMacho2', 'ancho_vena1', 'ancho_vena2', 'pin1', 'pin2'];

                    nombres = ['n_pieza', 'radiof_mordaza', 'radiof_mayor', 'radiof_sufridera', 'profuFinal_CFC', 'profuFinal_mitadMB', 'profuFinal_PCO', 'ensamble', 'distancia_barrenoAli', 'profu_barrenoAliHembra', 'profu_barrenoAliMacho', 'altura_venaHembra', 'altura_venaMacho', 'ancho_vena', 'pin1', 'pin2', 'error', 'observaciones'];
                    break;
