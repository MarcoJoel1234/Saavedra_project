...
@section('head')
<title>Reporte de palomas</title>
...
<div class="container">
    ...
    <form action="{{route('saveHeader')}}" method="post">
        @csrf
        <input type="hidden" name="proceso" value="palomas">
    ...
    <div class="disabled-tabla">
        <form action="{{ route('palomasHeader')}}" method="post">
            @csrf
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    <tr>
                        ...
                        <th class="t-title">Ancho de paloma</th>
                        <th class="t-title">Grueso de paloma</th>
                        <th class="t-title">Profundidad de paloma</th>
                        <th class="t-title">Rebaje de llanta</th>
                    ...
                    <tr>
                        <td>C.Nominal.</td>
                        <td><input type="number" value="{{$cNominal->anchoPaloma}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->gruesoPaloma}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->profundidadPaloma}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->rebajeLlanta}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td> Tolerancias. </td>
                        <td><input type="number" value="{{$tolerancia->anchoPaloma}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$tolerancia->gruesoPaloma}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$tolerancia->profundidadPaloma}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$tolerancia->rebajeLlanta}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td></td>
                        <td></td>
                    </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->anchoPaloma}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->gruesoPaloma}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->profundidadPaloma}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->rebajeLlanta}}" step="any" inputmode="decimal" readonly></td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->anchoPaloma}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->gruesoPaloma}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->profundidadPaloma}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->rebajeLlanta}}" step="any" inputmode="decimal" readonly></td>
                    ...
                    <tr>
                        ...
                        <td> <input type="number" name="anchoPaloma" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="gruesoPaloma" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="profundidadPaloma" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="rebajeLlanta" class="input" step="any" inputmode="decimal" required></td>
                        <td>
        ...
        <form action="{{ route('editPalomas')}}" method="post">
            @csrf
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" value="{{$nPiezas->anchoPaloma}}" name="anchoPaloma[]" step="any" inputmode="decimal" required></td>
                        <td><input type="number" class="input" value="{{$nPiezas->gruesoPaloma}}" name="gruesoPaloma[]" step="any" inputmode="decimal" required></td>
                        <td><input type="number" class="input" value="{{$nPiezas->profundidadPaloma}}" name="profundidadPaloma[]" step="any" inputmode="decimal" required></td>
                        <td><input type="number" class="input" value="{{$nPiezas->rebajeLlanta}}" name="rebajeLlanta[]" step="any" inputmode="decimal" required></td>
                        <td>
                            <select name="error[]" class="input">
