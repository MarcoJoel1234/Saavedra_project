...
@endisset
@if((isset($pzasRestantes) && count($pzasRestantes) <= 0) && $band != 4)
<!-- <script>
            ...
            <div class="datos">
                ...
                <div class="disabled">
                    ...
                    <div class="input-datos" id="div-clases">
                        ...
                        <label class="clases" style="margin-left: 120px;">{{count($pzasRestantes)}} piezas</label>
                        @endif
                    </div>
    ...
    <div class="disabled-tabla">
        <form action="{{ route('revLateralesHeader')}}" method="post">
            ...
            <div class="scrollabe-table">
                ...
                @if (isset($piezasUtilizar) && count($pzasRestantes) > 0 && !isset($piezaElegida))
