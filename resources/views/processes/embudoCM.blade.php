    ...
    <div class="container">
        ...
        @if (isset($band) && $band == 2)
            <div class="disabled-tabla">
                <form action="{{ route('embudoCMHeader')}}" method="post">
                    @csrf
                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <tr>
                                ...
                                <th class="t-title">Conexión línea de partida</th>
                                <th class="t-title">Conexión a 90°</th>
                                <th class="t-title">Altura de conexión</th>
                                <th class="t-title">Diametro Embudo</th>
                            ...
                            @else
                                <tr>
                                    <td>C.Nominal.</td>
                                    <td><input type="number" value="{{$cNominal->conexion_lineaPartida}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->conexion_90G}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->altura_conexion}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->diametro_embudo}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td> Tolerancias. </td>
                                    <td><input type="number" value="{{$tolerancia->conexion_lineaPartida}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->conexion_90G}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->altura_conexion}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->diametro_embudo}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            @endif
                            ...
                            @if (isset($nPiezas))
                                    ...
                                    @foreach ($nPiezas as $nPiezas)
                                        @if ($nPiezas->error != 'Ninguno')
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->conexion_lineaPartida}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->conexion_90G}}" step="any" inputmode="decimal" readonly></td>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametro_embudo}}" step="any" inputmode="decimal" readonly></td>
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->conexion_lineaPartida}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->conexion_90G}}" step="any" inputmode="decimal" readonly></td>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametro_embudo}}" step="any" inputmode="decimal" readonly></td>
                                ...
                                @if (isset($piezaElegida))
                                    <tr>
                                        ...
                                        <td> <input type="number" name="conexion_lineaPartida" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type="number" name="conexion_90G" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type="number" name="altura_conexion" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type= "number" name="diametro_embudo" class="input" step="any" inputmode="decimal" required></td>
                                        <td>
                ...
                @if (isset($nPiezas) && $nPiezas != "[]")
                    <form action="{{ route('editEmbudoCM')}}" method="post">
                        @csrf
        ...
        @if (isset($band) && $band == 4)
            <div class="disabled-tabla">
                <form action="{{ route('editEmbudoCM')}}" method="post">
                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <!--Encabezado de la tabla Embudo CM-->
                            <tr>
                                <th class="t-title" style="width:150px">#PZ</th>
                                <th class="t-title">Conexión línea de partida</th>
                                <th class="t-title">Conexión a 90°</th>
                            ...
                            @if ($nPiezas->count() != 0)
                                @foreach ($nPiezas as $nPiezas)-
                                    <tr>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->conexion_lineaPartida}}" name="conexion_lineaPartida[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->conexion_90G}}" name="conexion_90G[]" step="any" inputmode="decimal" required></td>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->diametro_embudo}}" name="diametro_embudo[]" step="any" inputmode="decimal" required></td>
                                        <td>
                                            <select name="error[]" class="input">
