...
<head>
    <title>Barreno para platos</title>
                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <tr>
                                ...
                                <th class="t-title">Broca </th>
                                <th class="t-title">Profundidad</th>
                                <th class="t-title">Diametro de arrastre 1</th>
                                <th class="t-title">Broca </th>
                                <th class="t-title">Profundidad</th>
                                <th class="t-title">Diametro de arrastre 2</th>
                                <th class="t-title">Broca </th>
                                <th class="t-title">Profundidad</th>
                                <th class="t-title">Diametro de arrastre 3</th>
                                <th class="t-title">Broca </th>
                                <th class="t-title">Profundidad</th>
                                <th class="t-title">Diametro de arrastre 4</th>
                            ...
                            @else 
                                <tr> 
                                    ...
                                    <td><input type="number" value="{{$cNominal->broca4}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->profundidad4}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->diametro_arrastre4}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td> Tolerancias. </td>
                                    <td><input type="number" value="{{$tolerancia->broca1}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->profundidad1}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->diametro_arrastre1}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->broca2}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->profundidad2}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->diametro_arrastre2}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->broca3}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->profundidad3}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->diametro_arrastre3}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->broca4}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->profundidad4}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->diametro_arrastre4}}" class="input-medio" step="any" inputmode="decimal" readonly></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            @endif
                            ...
                            @if (isset($nPiezas))
                                    ...
                                    @foreach ($nPiezas as $nPiezas)
                                        @if ($nPiezas->correcto == 0)
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->broca4}}" step="any" inputmode="decimal" readonly></td>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametro_arrastre4}}" step="any" inputmode="decimal" readonly></td>
                                        ...
                                        <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->broca4}}" step="any" inputmode="decimal" readonly></td>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametro_arrastre4}}" step="any" inputmode="decimal" readonly></td>
                                ...
                                @if (isset($piezaElegida))
                                    <tr>
                                        ...
                                        <td> <input type="number" name="diametro_arrastre4" class="input" step="any" inputmode="decimal" required></td>
                                        <td> 
                            ...
                            @if ($nPiezas->count() != 0)
                                @foreach ($nPiezas as $nPiezas)
                                    <tr>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->diametro_arrastre4}}" name="diametro_arrastre4[]" step="any" inputmode="decimal" required>
                                    </td
                                        <td> 
                                            <select name="error[]" class="input">
