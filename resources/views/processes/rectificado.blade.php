...
@vite(['resources/css/rectificado.css', 'resources/js/editarInterfaz.js', 'resources/js/editarTabla.js'])
@endsection
        ...
        <form action="{{ route('editRectificado')}}" method="post">
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="input" value="{{$nPiezas->n_juego}}" name="n_pieza[]" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                            <select name="cumple[]" style="width:150px">
                                <option value="{{$nPiezas->cumple}}">{{$nPiezas->cumple}}</option>
                                @if($nPiezas->cumple == '✓')
                                <option value="X">X</option>
                                @else
                                <option value="✓">✓</option>
