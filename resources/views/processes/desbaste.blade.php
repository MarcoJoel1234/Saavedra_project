                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <tr>
                                ...
                                <th class="t-title">Diametro de sufridera/Extra</th>
                                <th class="t-title">Simetria Ceja</th>
                                <th class="t-title">Simetria Mordaza</th>
                                <th class="t-title">Altura de ceja</th>
                                <th class="t-title">Altura sufridera</th><br>
                            ...
                            @else 
                                <tr> 
                                    ...
                                    <td><input type="number" value="{{$cNominal->diametro_sufrideraExtra}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->simetria_ceja}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->simetria_mordaza}}" class="input" step="any" inputmode="decimal" readonly></td>
                                ...
                                <tr>
                                    <td> Tolerancias. </td>
                                    <td>
                                        <input type="number" value="{{$tolerancia->diametro_mordaza1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->diametro_mordaza2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" value="{{$tolerancia->diametro_sufrideraExtra1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->diametro_sufrideraExtra2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                                    </td>
                                    <td>
                                        <input type="number" value="{{$tolerancia->simetria_ceja1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->simetria_ceja2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                                    </td>
                                    <td>
                                        <input type="number" value="{{$tolerancia->simetria_mordaza1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->simetria_mordaza2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                                    </td>
                                    <td>
                            ...
                            @if (isset($nPiezas))
                                    ...
                                    @foreach ($nPiezas as $nPiezas)
                                        @if ($nPiezas->correcto == 0)
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametro_sufrideraExtra}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->simetria_ceja}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->simetria_mordaza}}" step="any" inputmode="decimal" readonly></td>
                                                ...
                                                <td><input type="text" class="input" style="background-color:#F36456" value="{{$nPiezas->altura_sufridera}}" readonly></td>
                                        ...
                                        <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametro_sufrideraExtra}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->simetria_ceja}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->simetria_mordaza}}" step="any" inputmode="decimal" readonly></td>
                                                ...
                                                <td><input type="text" class="input" style="background-color:#90F77E" value="{{$nPiezas->altura_sufridera}}" readonly></td>
                                ...
                                @if (isset($piezaElegida))
                                    <tr>
                                        ...
                                        <td> <input type="number" name="diametro_sufrideraExtra" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type= "number" name="simetria_ceja" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type= "number" name="simetria_mordaza" class="input" step="any" inputmode="decimal" required></td>
                            ...
                            @if ($nPiezas->count() != 0)
                                @foreach ($nPiezas as $nPiezas)
                                    <tr>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->diametro_sufrideraExtra}}" name="diametro_sufrideraExtra[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->simetria_ceja}}" name="simetria_ceja[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->simetria_mordaza}}" name="simetria_mordaza[]" step="any" inputmode="decimal" required></td>
