...
<body background="{{ asset('images/hola.jpg') }}">
    <div class="container">
        ...
        <form action="{{route('saveHeader')}}" method="post">
            @csrf
            <input type="hidden" name="proceso" value="rebajes">
        ...
        @if (isset($band) && $band == 2)
            <div class="disabled-tabla">
                <form action="{{ route('rebajesHeader')}}" method="post">
                    @csrf
                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <tr>
                                ...
                                <th class="t-title">Rebaje 1</th>
                                <th class="t-title">Rebaje 2 </th>
                                <th class="t-title">Rebaje 3</th>
                                <th class="t-title">Profundidad de bordonio</th>
                                <th class="t-title">Vena 1</th>
                                <th class="t-title">Vena 2 </th>
                            ...
                            @else
                                <tr>
                                    <td>C.Nominal.</td>
                                    <td><input type="number" value="{{$cNominal->rebaje1}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->rebaje2}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->rebaje3}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->profundidad_bordonio}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->vena1}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$cNominal->vena2}}" class="input" step="any" inputmode="decimal" readonly></td>
                                ...
                                <tr>
                                    <td> Tolerancias. </td>
                                    <td><input type="number" value="{{$tolerancia->rebaje1}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->rebaje2}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->rebaje3}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->profundidad_bordonio}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->vena1}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->vena2}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td><input type="number" value="{{$tolerancia->simetria}}" class="input" step="any" inputmode="decimal" readonly></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            @endif
                            ...
                            @if (isset($nPiezas))
                                    ...
                                    @foreach ($nPiezas as $nPiezas)
                                        @if ($nPiezas->error != 'Ninguno')
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->rebaje1}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->rebaje2}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->rebaje3}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->profundidad_bordonio}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->vena1}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->vena2}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->simetria}}" step="any" inputmode="decimal" readonly></td>
                                        ...
                                        <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->rebaje1}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->rebaje2}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->rebaje3}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->profundidad_bordonio}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->vena1}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->vena2}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->simetria}}" step="any" inputmode="decimal" readonly></td>
                                ...
                                @if (isset($piezaElegida))
                                    <tr>
                                        ...
                                        <td> <input type="number" name="rebaje1" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type="number" name="rebaje2" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type="number" name="rebaje3" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type= "number" name="profundidad_bordonio" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type="number" name="vena1" class="input" step="any" inputmode="decimal" required></td>
                                        <td> <input type="number" name="vena2" class="input" step="any" inputmode="decimal" required></td>
                ...
                @if (isset($nPiezas) && $nPiezas != "[]")
                    <form action="{{ route('editRebajes')}}" method="post">
                        @csrf
                            ...
                            @if ($nPiezas->count() != 0)
                                @foreach ($nPiezas as $nPiezas)
                                    <tr>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->rebaje1}}" name="rebaje1[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->rebaje2}}" name="rebaje2[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->rebaje3}}" name="rebaje3[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->profundidad_bordonio}}" name="profundidad_bordonio[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->vena1}}" name="vena1[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->vena2}}" name="vena2[]" step="any" inputmode="decimal" required></td>
