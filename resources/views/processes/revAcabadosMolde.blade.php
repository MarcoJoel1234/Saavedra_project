...
@section('head')
<title>Revisión acabados molde</title>
...
<div class="container">
    ...
    <form action="{{route('saveHeader')}}" method="post">
        @csrf
        <input type="hidden" name="proceso" value="acabadoMolde">
    ...
    <div class="disabled-tabla">
        <form action="{{ route('acabadoMoldeHeader')}}" method="post">
            @csrf
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    <tr>
                        ...
                        <th class="t-title">Diametro conexión fondo</th>
                        <th class="t-title">Diametro llanta</th>
                        <th class="t-title">Diametro caja fondo</th>
                        <th class="t-title">Altura de conexión fondo</th>
                        <th class="t-title">Profundidad llanta</th>
                        <th class="t-title">Profundidad caja fondo</th>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="number" value="{{$cNominal->diametro_conexion_fondo}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->diametro_llanta}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->diametro_caja_fondo}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->altura_conexion_fondo}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->profundidad_llanta}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->profundidad_caja_fondo}}" class="input" step="any" inputmode="decimal" readonly></td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <input type="number" value="{{$tolerancia->diametro_conexion_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->diametro_conexion_fondo2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="number" value="{{$tolerancia->diametro_caja_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->diametro_caja_fondo2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                            <input type="number" value="{{$tolerancia->altura_conexion_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->altura_conexion_fondo2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                            <input type="number" value="{{$tolerancia->profundidad_llanta1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->profundidad_llanta2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                            <input type="number" value="{{$tolerancia->profundidad_caja_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->profundidad_caja_fondo2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametro_conexion_fondo}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametro_llanta}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametro_caja_fondo}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->altura_conexion_fondo}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->profundidad_llanta}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->profundidad_caja_fondo}}" step="any" inputmode="decimal" readonly></td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametro_conexion_fondo}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametro_llanta}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametro_caja_fondo}}" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->altura_conexion_fondo}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->profundidad_llanta}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->profundidad_caja_fondo}}" step="any" inputmode="decimal" readonly></td>
                    ...
                    <tr>
                        ...
                        <td> <input type="number" name="diametro_conexion_fondo" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="diametro_llanta" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="diametro_caja_fondo" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="altura_conexion_fondo" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="profundidad_llanta" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="profundidad_caja_fondo" class="input" step="any" inputmode="decimal" required></td>
        ...
        <form action="{{ route('editAcabadoMolde')}}" method="post">
            @csrf
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" value="{{$tolerancia->diametro_caja_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->diametro_caja_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                            <input type="number" value="{{$tolerancia->altura_conexion_fondo1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->altura_conexion_fondo2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" value="{{$nPiezas->diametro_conexion_fondo}}" name="diametro_conexion_fondo[]" step="any" inputmode="decimal" required></td>
                        ...
                        <td><input type="number" class="input" value="{{$nPiezas->diametro_caja_fondo}}" name="diametro_caja_fondo[]" step="any" inputmode="decimal" required></td>
                        <td><input type="number" class="input" value="{{$nPiezas->altura_conexion_fondo}}" name="altura_conexion_fondo[]" step="any" inputmode="decimal" required></td>
                        <td><input type="number" class="input" value="{{$nPiezas->profundidad_llanta}}" name="profundidad_llanta[]" step="any" inputmode="decimal" required></td>
                        <td><input type="number" class="input" value="{{$nPiezas->profundidad_caja_fondo}}" name="profundidad_caja_fondo[]" step="any" inputmode="decimal" required></td>
