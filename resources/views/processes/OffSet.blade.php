                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            ...
                            @else
                                ...
                                <tr>
                                    <td> Tolerancias </td>
                                    <td><input type="number" value="{{$tolerancia->anchoRanura}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->profuTaconHembra}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->profuTaconMacho}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->simetriaHembra}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->simetriaMacho}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->anchoTacon}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->barrenoLateralHembra}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->barrenoLateralMacho}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->alturaTaconInicial}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td><input type="number" value="{{$tolerancia->alturaTaconIntermedia}}" class="input" step="any" inputmode="decimal" required></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            @endif
                                    ...
                                    @foreach ($nPiezas as $nPiezas)
                                        @if ($nPiezas->correcto == 0)
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->simetriaHembra}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->simetriaMacho}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->anchoTacon}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->barrenoLateralHembra}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->barrenoLateralMacho}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->alturaTaconInicial}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->alturaTaconIntermedia}}" step="any" inputmode="decimal" readonly></td>
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->simetriaHembra}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->simetriaMacho}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->anchoTacon}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->barrenoLateralHembra}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->barrenoLateralMacho}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->alturaTaconInicial}}" step="any" inputmode="decimal" readonly></td>
                                                <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->alturaTaconIntermedia}}" step="any" inputmode="decimal" readonly></td>
        ...
        @if (isset($band) && $band == 4)
            <div class="disabled-tabla">
                <form action="{{ route('editDesbaste')}}" method="post">
                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <!--Encabezado de la tabla Ranura OffSet-->
                            <tr>
                                <th class="t-title" style="width:150px; border:none;">#PZ</th>
                                <th class="t-title" colspan="1" style="width:200px; border-bottom:none;">Ancho de altura</th>
                                <th class="t-title" colspan="2">Profundidad de tacon</th>
                            ...
                            <!-- Parte del encabezado de Ranura OffSet, ya que van celdas combinadas -->
                            <tr>
                                <th class="t-title" style="border:none;"></th>
                                <th style="border-bottom:none; border-top:none;"></th>
                                <th>Hembra</th>
                            ...
                            <!-- Termina encabezado de la tabla de Ranura OffSet -->
                            <tr>
                                <td>C.Nominal</td>
                                <td><input type="number" value="{{$cNominal->anchoRanura}}" class="input" step="any" inputmode="decimal" required></td>
                                <td><input type="number" value="{{$cNominal->profuTaconHembra}}" class="input-medio" step="any" inputmode="decimal" required><td>
                            ...
                            @if ($nPiezas->count() != 0)
                                @foreach ($nPiezas as $nPiezas)
                                    <tr>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->anchoRanura}}" name="anchoRanura[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->profuTaconHembra}}" name="profuTaconHembra[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->profuTaconMacho}}" name="profuTaconMacho[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->simetriaHembra}}" name="simetriaHembra[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->simetriaMacho}}" name="simetriaMacho[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->anchoTacon}}" name="anchoTacon[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->barrenoLateralHembra}}" name="barrenoLateralHembra[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->barrenoLateralMacho}}" name="barrenoLateralMacho[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->alturaTaconInicial}}" name="alturaTaconInicial[]" step="any" inputmode="decimal" required></td>
                                        <td><input type="number" class="input" value="{{$nPiezas->alturaTaconIntermedia}}" name="alturaTaconIntermedia[]" step="any" inputmode="decimal" required></td>
                                        <td>
                                            <select name="error[]" class="input">
