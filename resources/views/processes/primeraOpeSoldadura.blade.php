...
@section('head')
<title>Primera Operación Soldadura</title>
...
<div class="container">
    ...
    <div class="disabled-tabla">
        <form action="{{ route('primeraOpeSoldaduraHeader')}}" method="post">
            @csrf
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    <tr>
                        ...
                        <th class="t-title">Diametro barreno</th>
                        <th class="t-title">Simetría línea de partida</th>
                        <th class="t-title">Perno de alineación </th><br>
                    ...
                    <tr>
                        ...
                        <td><input type="number" value="{{$cNominal->diametroBarreno}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->simetriaLinea_partida}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$cNominal->pernoAlineacion}}" class="input" step="any" inputmode="decimal" readonly></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" value="{{$tolerancia->diametroBarreno1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->diametroBarreno2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td>
                            <input type="number" value="{{$tolerancia->simetriaLinea_partida1}}" class="input-medio" step="any" inputmode="decimal" readonly><input type="number" value="{{$tolerancia->simetriaLinea_partida2}}" class="input-medio" step="any" inputmode="decimal" readonly>
                        </td>
                        <td><input type="number" value="{{$tolerancia->pernoAlineacion}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td><input type="number" value="{{$tolerancia->Simetria90G}}" class="input" step="any" inputmode="decimal" readonly></td>
                        <td></td>
                        <td></td>
                    </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->diametroBarreno}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->simetriaLinea_partida}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#F36456" value="{{$nPiezas->pernoAlineacion}}" readonly></td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->diametroBarreno}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->simetriaLinea_partida}}" readonly></td>
                        <td><input type="number" class="input" style="background-color:#90F77E" value="{{$nPiezas->pernoAlineacion}}" readonly></td>
                    ...
                    <tr>
                        ...
                        <td> <input type="number" name="diametroBarreno" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="simetriaLinea_partida" class="input" step="any" inputmode="decimal" required></td>
                        <td> <input type="number" name="pernoAlineacion" class="input" step="any" inputmode="decimal" required></td>
        ...
        <form action="{{ route('editPrimeraOpeSoldadura')}}" method="post">
            @csrf
            ...
            <div class="scrollabe-table">
                <table border="1" class="tabla3">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="input" value="{{$nPiezas->diametroBarreno}}" name="diametroBarreno[]" step="any" inputmode="decimal" required></td>
                        ...
                        <td><input type="number" class="input" value="{{$nPiezas->pernoAlineacion}}" name="pernoAlineacion[]" step="any" inputmode="decimal" required></td>
