                    ...
                    <div class="scrollabe-table">
                        <table border="1" class="tabla3">
                            <tr>
                                ...
                                <th class="t-title">Tiempo de precalentado</th>
                            ...
                            @if (isset($nPiezas))
                                @if ($nPiezas->count() != 0)
                                    @foreach ($nPiezas as $nPiezas)
                                        <tr>
                                            ...
                                            <td><input type="number" class="input" value="{{$nPiezas->pesoxpieza}}" step="any" inputmode="decimal" readonly></td>
                                            <td><input type="number" class="input" value="{{$nPiezas->tiempo_precalentado}}" step="any" inputmode="decimal" readonly></td>
                                            <td><input type="number" class="input" value="{{$nPiezas->temperatura_precalentado}}" step="any" inputmode="decimal" readonly></td>
                                            <td><input type="number" class="input" value="{{$nPiezas->tiempo_aplicacion}}" step="any" inputmode="decimal" readonly></td>
                                            <td><input type="text" class="input" value="{{$nPiezas->tipo_soldadura}}" readonly></td>
                                            <td><input type="text" class="input" value="{{$nPiezas->lote}}" readonly></td>
                                ...
                                @if (isset($piezaElegida))
                                    <tr>
                                        ...
                                        <td> <input type="number" name="tiempo_precalentado" class="input" step="any" inputmode="decimal" required></td>
                            ...
                            @if ($nPiezas->count() != 0)
                                @foreach ($nPiezas as $nPiezas)
                                    <tr>
                                        ...
                                        <td><input type="number" class="input" value="{{$nPiezas->tiempo_precalentado}}" name="tiempo_precalentado[]" step="any" inputmode="decimal" required></td>
