...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('segundaOpeSoldadura_pza')) {
            Schema::create('segundaOpeSoldadura_pza', function (Blueprint $table) {
                $table->id();
                $table->string('id_pza');
                ...
                $table->foreign('id_proceso')->references('id')->on('segundaOpeSoldadura');
            });
        }
    }
    ...
    {
        Schema::dropIfExists('segundaOpeSoldadura_pza');
    }
};
