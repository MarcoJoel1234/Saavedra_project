...
use App\Http\Requests\WORequest;
...
class WOController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->processesController = new ProcesosController();
    }
    ...
    public function manage()
    {
        ...
        return view('wOrder_views.manageWO', compact('moldings', 'workOrders'));
    }

    public function store(WORequest $request) //Funcion para registrar una OT.
    {
    ...
    public function show($workOrder){
        ...
        return view('wOrder_views.showWO', compact('workOrder', 'molding', 'classes', 'processes'));
    }
    ...
    public function destroy($idWOrder)
    {
        ...
        if (count($pieces) == 0 && count($goal) == 0) { //Si la OT no tiene piezas ni metas asociadas entonces
            ...
            Orden_trabajo::find($idWOrder)->delete(); //Elimino la OT
    ...
    public function generatePDF($idWOrder){
        ...
        $pdf = FacadePdf::loadView('wOrder_views.pdfWO', compact('workOrder', 'molding', 'classes', 'processes'));
